...
<body>
    ...
    <header class="p-5 m-4 bg-light rounded-3 border ">
        <section class="container py-5">
            <h1 class="display-5 fw-bold">Importations de fichiers en PHP avec "require()" et "include()"</h1>
            ...
            <p>Lorsque l'on crée un fichier que l'on veut inclure, la convention dit que l'on ajoute "<span>.inc</span>" avant "<span>.php</span>" et on crée ces fichier dans un dossier nommé "<span>inc.</span>" Il n'y a pas d'influence sur la lecture du fichier, c'est une convention et une organisation.</p>
        </section>
    </header>
    <!-- fin header -->
